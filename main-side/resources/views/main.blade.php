...
<head>
    ...
    <!-- TEXT ROTATOR -->
    <link rel="stylesheet" href="css\text-rotator.css">
...
<body>
    ...
    <div id="wrap" class="boxed ">
        <div class="grey-bg">
            ...
            <header id="nav-stick2" class="header header-1 header-side-menu fixed white transparent">
                <div class="header-wrapper">
                    <div class="container-m-30 clearfix">
                        <div class="logo-row logo-hiding">
            ...
            <!-- STATIC MEDIA IMAGE -->
            <div id="index-link" class="sm-img-bg-fullscr parallax-section"
                style="background-image: url(images/wp4190084-ho-chi-minh-city-wallpapers.jpg)"
                        ...
                        <div class="opacity-scroll2">
                            ...
                            <h1 class="cd-headline zoom light-72-wide sm-mt-20  sm-mb-20">
                                ...
                                <span class="cd-words-wrapper waiting">
                                    ...
                                    <b>GIÚP BẠN</b>
                                    <b>PHÁT TRIỂN ƯỚC MƠ</b>
                                </span>
                            </h1>

                            <!-- LAYER NR. 2 -->
                            <div class="norm-16-wide hide-0-736 sm-mb-60">
                                WEBSITE<span class="slash-divider-10">/</span>DESIGN<span
                                    class="slash-divider-10">/</span>LOGO<span class="slash-divider-10">/</span>
                                ADVERTISEMENT
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="fes4-box wow fadeIn" data-wow-delay="200ms">
                                ...
                                <div>
                                    Maecenas luctus nisi in sem fermentum blat. In nec elit solliudin, elementum, dictum
                                    pur quam volutpat suscipit antena.
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="fes4-box wow fadeIn" data-wow-delay="400ms">
                                ...
                                <div>
                                    Seductio maesto nisi in sem fermentum blat. In nec elit solliudin, elementum, dictum
                                    pur quam volutpat suscipit antena.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="fes4-box wow fadeIn" data-wow-delay="600ms">
                                ...
                                <div>
                                    ...
                                    dictum pur quam volutpat suscipit antena.
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="fes4-box wow fadeIn" data-wow-delay="800ms">
                                ...
                                <div>
                                    Lorem luctus antena at nisi in sem blandit. In nec elit soltudin, elementum odio et,
                                    dictum quam a volutpat elementum.
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 wow fadeInLeft equal-height ">
                            <div class="fes2-main-text-cont">
                                ...
                                <div class="fes2-text-cont">Sed ut perspiciatis unde omnis iste nat eror acus antium
                                    que. Asperiores, ea velit enim labore doloribus.</div>
                            </div>
                        </div>
                    ...
                    <ul class="port-grid port-grid-3 port-grid-gut clearfix" id="items-grid">
                        ...
                        <li class="port-item mix">
                            <a href="portfolio-single1.html">
                                <div class="port-img-overlay"><img class="port-main-img"
                                        src="images\portfolio\projects-5.jpg" alt="img"></div>
                            </a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center wow fadeInUp" data-wow-duration="1s">
                            <img src="images\team\team-all.jpg" alt="img">
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 left-50">
                            <div class="fes2-main-text-cont">
                                ...
                                <div class="fes2-text-cont">Sed ut perspiciatis unde omnis iste nat eror acus antium
                                    que. Asperiores, ea velit enim labore doloribus.</div>
                                <div class="mt-30">
                                    <a class="button medium thin hover-dark" href="https://1.envato.market/GVZ26">BUY
                                        NOW</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="page-section pt-110-b-30-cont">
                <div class="container">
                    ...
                    <div class="mb-50">
                        <h2 class="section-title pr-0">LATEST <span class="bold">NEWS</span><a
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-70">
                            ...
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="images\blog\post-prev-1.jpg"
                                        alt="img"></a>
                            </div>
                            ...
                            <div class="post-prev-info">
                                JULE 10<span class="slash-divider">/</span><a href="https://1.envato.market/a1gQR">JOHN
                                    DOE</a>
                            </div>

                            <div class="post-prev-text">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae, nostrum, cumque
                            ...
                            <div class="post-prev-more-cont clearfix">
                                ...
                                <div class="right">
                                    <a href="blog-single-sidebar-right.html#comments" class="post-prev-count"><span
                                            aria-hidden="true" class="icon_comment_alt"></span><span
                                            class="icon-count">21</span></a>
                                    <a href="https://1.envato.market/a1gQR" class="post-prev-count"><span
                                            aria-hidden="true" class="icon_heart_alt"></span><span
                                            class="icon-count">53</span></a>
                                    ...
                                    <ul class="social-menu dropdown-menu dropdown-menu-right" role="menu">
                                        ...
                                        <li><a href="#"><span aria-hidden="true" class="social_dribbble"></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-70" data-wow-delay="200ms">
                            ...
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="images\blog\post-prev-2.jpg"
                                        alt="img"></a>
                            </div>
                            ...
                            <div class="post-prev-info">
                                MAY 11<span class="slash-divider">/</span><a href="https://1.envato.market/a1gQR">JOHN
                                    DOE</a>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-70" data-wow-delay="400ms">
                            ...
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="images\blog\post-prev-3.jpg"
                                        alt="img"></a>
                            </div>
                            ...
                            <div class="post-prev-info">
                                DECEMBER 21<span class="slash-divider">/</span><a
                                    href="https://1.envato.market/a1gQR">JOHN DOE</a>
                            </div>
                        ...
                        <div id="mc_embed_signup" class="nl-form-container clearfix">
                            <form
                                ...
                                <div style="position: absolute; left: -5000px;"><input type="text"
                                        name="b_ba37086d08bdc9f56f3592af0_e38247f7cc" tabindex="-1" value=""></div>
            ...
            <footer id="footer1" class="page-section text-center pt-100-b-80-cont">
                <div class="container mt-20">
                    ...
                    <div class="footer-copy">
                        <a href="http://themeforest.net/user/abcgomel/portfolio" target="_blank">© HASWELL 2020</a>
                    </div>
            ...
            <!-- MENU -->
            <nav>
                <div class="fs-primary-nav fs-sub-nav">
                    ...
                    <div class="fs-table">
                        <div class="fs-table-cell">
                            <ul>
                                ...
                                <li>
                                    <a href="#" class="fs-parent">PORTFOLIO<span class="open-sub"></span></a>
                                    <ul class="fs-sub">
                                        <!-- <li>
          		        <a class="fs-parent" href="special-photographer-1-portfolio.html">Corporate<span class="open-sub"></span></a>
          		        <ul class="fs-sub">
                          ...
                          <li><a href="agency.html">Agency<span class="label-new">new</span></a></li>
                                        ...
                                        <li>
                                            <a href="portfolio-grid.html#branding-section">Branding</a>
                                        </li>
                                        <li>
                                            <a href="portfolio-grid.html#web-design-section">Web Design</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="fs-label">WORK WITH US</li>

                                <li class="fs-a-sec"><a href="#">Join In</a></li>
                                <li class="fs-a-sec"><a href="#">Create an Account</a></li>

                                <li class="fs-label">Follow us</li>

                                <li class="footer-2-soc-a mt-20">
                                    <a href="https://1.envato.market/a1gQR" title="Facebook" target="_blank"><i
                                            class="fa fa-facebook"></i></a>
                                    <a href="https://1.envato.market/a1gQR" title="Twitter" target="_blank"><i
                                            class="fa fa-twitter"></i></a>
    ...
    <!-- TEXT ROTATOR -->
    <script src="js\text-rotator.js"></script>
