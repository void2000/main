...
<!-- JS begin some js files in bottom of file-->
	...
	<body>
      ...
      <div id="loader3">Please enable JS</div>
        ...
        <!-- STATIC MEDIA IMAGE -->
        <div id="index-link" class="sm-img-bg-fullscr parallax-section" style="background-image: url(images/wp4190084-ho-chi-minh-city-wallpapers.jpg)" data-stellar-background-ratio="0.5">
            <div class="cloud"></div>
                      <div class="container sm-content-cont js-height-fullscr">
                        <div class="sm-cont-middle">
                            ...
                            <h1 class="cd-headline zoom light-72-wide sm-mt-20  sm-mb-20">
                              ...
                              WEBSITE<span class="slash-divider-10">/</span>DESIGN<span class="slash-divider-10">/</span>LOGO<span class="slash-divider-10">/</span>
            ADVERTISEMENT
                                          </div>
            
                                        <!-- LAYER NR. 3 -->
                                          <div class="center-0-478">
                              <a class="button medium hover-dark tp-button gray smooth-scroll" href="#c1">XEM THÊM</a><a class="button medium hover-dark tp-button gray ml-20" href="https://1.envato.market/GVZ26">LIÊN HỆ</a>
                                          </div>
